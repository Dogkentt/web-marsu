...
import { ConnectWithUsMap } from "@/widgets";

const ConnectWithUs = () => {
    return (
        <section className={cn(styles["connect-with-us"], "margin-top")}>
            <div className={styles["connect-with-us__info"]}>
                <div className={styles["connect-with-us__container"]}>
                    ...
                    <div className={styles["connect-with-us__contacts"]}>
                        ...
                        <div className={styles["connect-with-us__contacts-item"]}>
                            ...
                            <p className={styles["connect-with-us__contacts-item-detail"]}>Horizon Convention CenterAmsterdam, Netherlands</p>
                        </div>
